 ...
 * no changes to default implementation
 */
public class DeviceRetrieverNodePlugin extends Plugin {
	// The shared instance.
	private static DeviceRetrieverNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public DeviceRetrieverNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static DeviceRetrieverNodePlugin getDefault() {
		return plugin;
	}
