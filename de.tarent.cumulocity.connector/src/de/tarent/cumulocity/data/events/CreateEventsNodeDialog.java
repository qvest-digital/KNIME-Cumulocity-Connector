...
import de.tarent.cumulocity.data.events.CreateEventsNodeModel.COLUMN_KEYS;
 ...
 */
public class CreateEventsNodeDialog extends DefaultNodeSettingsPane {
		...
		for (COLUMN_KEYS key : COLUMN_KEYS.values()) {
			...
			if (cellClass != null) {
				final DialogComponent col = new DialogComponentColumnNameSelection(model, key.toString(),
						CreateEventsNodeModel.IN_PORT_DATA_TABLE, key.m_isRequired, !key.m_isRequired,
